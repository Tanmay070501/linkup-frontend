  ...
  return (
    <div className="flex flex-col gap-2 w-full">
        ...
        <div className="w-full relative">
          <input value={value} ref={ref} className={`w-full text-base border rounded-lg p-2 ${error && "border-red-400"} placeholder:font-extralight ${startIcon && "pl-10"}`}  type={type} placeholder={placeholder} />
          {startIcon && <div className="h-full flex items-center justify-center absolute left-0 mx-3 top-1/2 -translate-y-1/2" >
            {startIcon}
          </div>}
